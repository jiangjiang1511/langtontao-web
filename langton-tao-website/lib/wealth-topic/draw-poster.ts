...
export function buildWealthTopicShareUrl() {
  if (typeof window === 'undefined') {
    return '/coffee#invest'
  }
  return `${window.location.origin}/coffee#invest`
}
...
export async function drawWealthTopicSharePoster(
  ...
  try {
    ...
    console.error('Wealth topic poster QR failed:', qrError)
