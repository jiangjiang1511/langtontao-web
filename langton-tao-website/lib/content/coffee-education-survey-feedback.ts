...
> = {
  'proc-child-security': {
    ...
    headline: '为孩子存下一份可预期的未来',
    reflection:
      '你们更关心的是长期底线的搭建——教育金、人生保障，是把不确定性从「会不会发生」变成「发生时家里站得住」。这背后往往是对责任感的具体化：不是今天多花一点，而是为未来留一条可执行的退路。',
    invite: '把保障写成家庭语言，比挂在嘴上的「为孩子好」更诚实。',
    softCta: comingSoonCta('了解如何搭建长期保障'),
  },
  'proc-fertility-support': {
    id: 'proc-fertility-support',
    headline: '在生育路径上保留选项与养护',
    reflection:
      '你们在用医学、时间与身心状态对抗不确定性——冻卵冻精、备孕养护、辅助生育，本质都是在延长「还可以再想想」的窗口。值得持续追问的是：技术能保留选项，伴侣之间的期待与成本分担是否也已对齐？',
    invite: '保留窗口之前，先对齐「我们要不要」比急着赶路更重要。',
    softCta: comingSoonCta('了解生育路径上的支持'),
  },
  'proc-pet-family': {
    id: 'proc-pet-family',
    headline: '把陪伴也当作家庭责任',
    ...
    softCta: comingSoonCta('了解宠物家庭的保障安排'),
  },
  'philo-open-world': {
    id: 'philo-open-world',
    headline: '推开世界的门',
    ...
    invite: '视野不是天赋，是家庭愿意持续投入的认知基础设施。',
    softCta: {
      label: '了解如何推开世界的门',
      href: '/education',
    },
  ...
  'philo-global-embodied': {
    ...
    headline: '与社会轻轻交手',
    reflection:
      '你们看重具身认知与真实场域里的学习——在不同国家、不同文化背景中，用 PBL 的方式看世界、认识自己。一年全球游走，本质上是让孩子与社会轻轻交手，而非隔窗观火。',
