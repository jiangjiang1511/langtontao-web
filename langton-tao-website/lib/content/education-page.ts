...
export const readingSectionMeta = {
  ...
  tagline: '开启人生认知定投',
  helper:
    '为家庭成员与社群成员建立同频的认知底层，构建关系与对话的基础。每月围读围绕活着、养老、教育、婚姻、传承五件人生大事展开。',
} as const

export const readingPhilosophyIntro = {
  title: '为什么要开启人生认知定投',
  paragraphs: [
    '活着、养老、教育、婚姻、传承——五件人生大事，每一件都在改写家庭资产负债表，也在改写你与伴侣、父母、子女之间的信任边界。它们不是孤立的个人功课，而是关系里的共同敞口：现金流怎么守、长寿风险怎么防、代际承诺怎么立、婚育与家庭结构怎么治理、财富怎么跨代传递。认知定投，是为这些议题准备一套共通语言——先在同频判断上对齐，再谈产品与交付。',
    '提升认知的路上，最难的不是「读了多少书」，而是没有人陪你把判断说到底。独自琢磨，旧经验容易被当成真理；周期一来，贪婪与恐惧也会把家庭带回各自为战的局面。朗敦道围读与沙龙，是把家庭成员与社群成员拉进同一张桌上的练习——彼此纠错、彼此见证，让认知从「我觉得」变成「我们经得起讨论」。人生大事，不该单打独斗。',
  ],
  ctaLabel: '加入我们',
  ctaHref: '/member',
} as const
