...
export const readingSectionMeta = {
  ...
  tagline: '开启人生认知定投',
  helper:
    '为家庭成员与社群成员建立同频的认知底层，构建关系与对话的基础。每月围读围绕活着、联盟、教育、养老、传承五件人生大事展开。',
} as const

export const readingPhilosophyIntro = {
  title: '一起开启认知定投',
  paragraphs: [
    '活着、联盟、教育、养老、传承——五件人生大事，牵动你与家人的信任，牵动与朋友、与社会的边界。每一件都有盲区，却常被当成只能独自扛的私事。',
    '认知定投，是把难题摆上同一张桌：一起交流、彼此纠错，再谈判断与行动。加入朗敦道围读与社群，别一个人摸索。',
  ],
  ctaLabel: '加入我们',
  ctaHref: '/member',
} as const
