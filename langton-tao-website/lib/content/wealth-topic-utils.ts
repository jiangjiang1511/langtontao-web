...
export const WEALTH_TOPIC_VISUAL_THEMES = [
  {
    ...
    coverOverlay:
      'linear-gradient(145deg, rgba(250, 250, 250, 0.88) 0%, rgba(244, 244, 245, 0.8) 45%, rgba(255, 230, 0, 0.42) 140%)',
    glyph: '#09090b',
  },
  {
    background:
    ...
    coverOverlay:
      'linear-gradient(145deg, rgba(255, 254, 245, 0.9) 0%, rgba(255, 249, 196, 0.78) 50%, rgba(255, 230, 0, 0.48) 100%)',
    glyph: '#09090b',
  },
  {
    background:
